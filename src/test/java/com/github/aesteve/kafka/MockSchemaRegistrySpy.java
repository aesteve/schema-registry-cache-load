...
public class MockSchemaRegistrySpy implements SchemaRegistryClient {

    private static final Logger log = LoggerFactory.getLogger(MockSchemaRegistryClient.class);


    final AtomicInteger callsToSR = new AtomicInteger(0);


    private static final String WILDCARD = "*";

    private String defaultCompatibility = "BACKWARD";
    final Map<String, Map<ParsedSchema, Integer>> schemaCache;
    final Map<String, Map<ParsedSchema, Integer>> schemaIdCache;
    final Map<String, Map<Integer, ParsedSchema>> idCache;
    final Map<String, Map<ParsedSchema, Integer>> versionCache;
    final Map<String, String> compatibilityCache;
    final Map<String, String> modes;
    final Map<String, AtomicInteger> ids;
    final Map<String, SchemaProvider> providers;

    private static final String NO_SUBJECT = "";

    public MockSchemaRegistrySpy() {
        this(null);
    }

    public MockSchemaRegistrySpy(List<SchemaProvider> providers) {
    ...
    // README: This is the method we want to spy
    // PowerMock didn't help, and since it's private, we had to copy / paste the whole class
    private int getIdFromRegistry(
            String subject, ParsedSchema schema, boolean registerRequest, int id)
            throws IOException, RestClientException {
        callsToSR.incrementAndGet();
